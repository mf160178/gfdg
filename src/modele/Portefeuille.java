...
public class Portefeuille implements Serializable {
    ...
    public Instrument getInstrument(String key) throws InstrumentInexistant {
        Instrument searched = null;
        try {
            if (this.mapInstrument.get(key) == null) {
                throw new ErreurRecherche();
    ...
    public Fonds getFond(String key) throws FondsInexistants {
        Fonds searched = null;
        try {
            if (this.mapFonds.get(key) == null) {
                throw new ErreurRecherche();
            }
            searched = this.mapFonds.get(key);
        } catch (ErreurRecherche erreur) {
