...
public class TP4 {
    ...
    public static void main(String[] args) {
        ...
        System.out.print("Indiquer la valeur d'un fond: ");
        ...
        System.out.print("Entrer le montant du fond à comparer: ");
        double amount2 = scan.nextDouble();
        Fonds fond2 = new Fonds(amount2, "Fond à comparer");
